...
echo -e $BlueF"       \/                         \/                  "$BlueF"   /"
echo -e $BlueF"   | "$cyan"Brutall Created By   "$white": "$red"Rahmat Rajib   "$BlueF" /"
echo -e $BlueF"   | "$cyan"Version              "$white": "$red"$version                       "$BlueF" /"
echo -e $BlueF"   | "$cyan"Codename             "$white": "$red"$codename	             "$BlueF" /"
echo -e $BlueF"   | "$cyan"Follow me on Github  "$white": "$red"@SilverThron3               "$BlueF"/"
echo -e $BlueF"   | "$cyan"Dracos Linux         "$white": "$red"dragon-linux.org        "$BlueF"/"
echo -e "$BlueF""   ------------------------------------------------"
echo -e $white " "
...
echo -e $BlueF"   | "$cyan"Codename             "$white": "$red"$codename	             "$BlueF" /"
echo -e $BlueF"   | "$cyan"Follow me on Github  "$white": "$red"@SilverThron3               "$BlueF"/"
echo -e $BlueF"   | "$cyan"Dragon Linux         "$white": "$red"dragon-linux.org        "$BlueF"/"
echo -e "$BlueF""   ------------------------------------------------"
echo -e $white " "
echo -e $BlueF"	[$white"01"$BlueF]$cyan  Meterpreter Reverse TCP Injection using Powershell  "
echo -e $BlueF"	[$white"02"$BlueF]$cyan  Download and Execute Backdoor  "
